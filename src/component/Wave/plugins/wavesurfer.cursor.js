/*!
 * wavesurfer.js 2.0.6 (Mon Jul 02 2018 10:16:27 GMT+0800 (CST))
...
var CursorPlugin = function () {
    ...
    function CursorPlugin(params, ws) {
        ...
        this._onMousemove = function (e) {
            ...
            var time = _this.wavesurfer.drawer.handleEvent(e) * _this.wavesurfer.getDuration();
            _this.title.textContent = Math.floor(time % 3600 / 60) + ':' + Math.floor(time % 60);
        };
